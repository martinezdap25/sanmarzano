        ...
        {items.length > 0 && (
          <div className="px-5 pt-4 pb-6 border-t border-brand-cream-dark shrink-0 space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#25D366] text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2.5 hover:bg-[#1DA851] active:scale-[0.98] transition-all duration-150 text-sm shadow-lg shadow-green-900/20"
            >
